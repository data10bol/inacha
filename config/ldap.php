            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '192.168.2.100')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'dc=ofep,dc=gob,dc=bo'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'Administrator@ofep.gob.bo'),
                'password' => env('LDAP_PASSWORD', 'Castlevania1*'),
