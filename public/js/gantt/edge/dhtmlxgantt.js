...
!function (t) {
    ...
    getNodePosition: i, getFocusableNodes: function (t) {
      ...
      for (void 0 === i && (i = !0); n;) {
        if (r = o(n)) {
          ...
          if (a >= 0) {
            if (!i) return n;
            var s = 0 === a || !d(r.charAt(a - 1)), l = a + e.length >= r.length || !d(r.charAt(a + e.length));
            if (s && l) return n
          }
        }
        n = n.parentNode
  ...
  l.prototype = {
    init: function (t) {
      ...
      var e = this.$getConfig(), i = e[this.$config.bind + "_attribute"], n = e[this.$config.bindLinks + "_attribute"];
      ...
      if (!t._isAllowedUnscheduledTask(e)) {
        ...
        var _ = function (e, i, n, r) {
          ...
          if (t.getTaskType(l.type) == a.types.milestone ? s.push("gantt_milestone") : t.getTaskType(l.type) == a.types.project && s.push("gantt_project"), s.push("gantt_bar_" + t.getTaskType(l.type)), t.isSummaryTask(l) && s.push("gantt_dependent_task"), t.isSplitTask(l) && s.push("gantt_split_parent"), a.select_task && n == o.selected_task && s.push("gantt_selected"), n == o.drag_id && (s.push("gantt_drag_" + o.drag_mode), o.touch_drag && s.push("gantt_touch_" + o.drag_mode)), o.link_source_id == n && s.push("gantt_link_source"), o.link_target_id == n && s.push("gantt_link_target"), a.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(l) && s.push("gantt_critical_task"), o.link_landing_area && o.link_target_id && o.link_source_id && o.link_target_id != o.link_source_id) {
            var c = o.link_source_id, d = o.link_from_start, h = o.link_to_start, u = t.isLinkAllowed(c, n, d, h),
              g = "";
  ...
  t.exports = function (t) {
    return function (e, i) {
      e || t.config.show_errors && !1 !== t.callEvent("onError", [i]) && t.message({type: "error", text: i, expire: -1})
    }
  }
}, function (t, e, i) {
  var n = i(1), r = i(3);
  ...
  t.exports = function (t) {
    t.skins.material = {
      ...
      _redefine_lightbox_buttons: {buttons_left: ["dhx_delete_btn"], buttons_right: ["dhx_save_btn", "dhx_cancel_btn"]}
  ...
  t.exports = function (t) {
    ...
    return n(r, e), r.prototype.render = function (e) {
      ...
      function m() {
        var i = a.call(t, e, r), o = s.call(t, e, r), l = t.calculateEndDate({start_date: i, duration: o, task: n});
  ...
  t.exports = function (t) {
    ...
    t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function () {
      ...
      t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function () {
        ...
        var n = i || window.event, r = i.target || i.srcElement, a = e.getClassName(r).indexOf("gantt_btn_set") > -1;
        switch ((i || n).keyCode) {
  ...
  i.prototype = {
    getWorkHours: function () {
      ...
      var t = this.argumentsHelper.calculateEndDateArguments.apply(this.argumentsHelper, arguments), e = t.start_date,
        i = t.duration, n = t.unit, r = t.step;
  ...
  a.prototype = {
    units: ["year", "month", "week", "day", "hour", "minute"], _getUnitOrder: function (t) {
      ...
      var t = this.argumentsHelper.calculateEndDateArguments.apply(this.argumentsHelper, arguments), e = t.start_date,
        i = t.duration, n = t.unit, r = t.step, a = t.duration >= 0 ? 1 : -1;
      ...
      var e = t.unit, i = this.$gantt.date[e + "_start"](new Date(t.date)), n = new Date(i), r = new Date(i), a = !0,
        s = 0, o = "any" == t.dir || !t.dir, l = 1;
      "past" == t.dir && (l = -1);
  ...
  s.prototype = {
    ...
    createCalendar: function (t) {
      ...
      n.mixin(e, i);
      var s = {id: n.uid() + "", worktime: this._convertWorktimeSettings(e)}, o = new a(this.$gantt, r(this.$gantt));
  ...
  t.exports = function (t) {
    ...
    function i() {
      ...
      if (!e.length || !t.isTaskExists(e[0].id)) {
        var i = {unscheduled: !0, type: t.config.types.placeholder, duration: 0, text: t.locale.labels.new_task};
  ...
  function r(t) {
    ...
    function s(t, e, i, n) {
      var r = 100 * (1 - (1 * t || 0)), a = n.posFromDate(e), s = n.posFromDate(i), o = document.createElement("div");
        ...
        if (c.length) {
          ...
          var b = function (e, i, n) {
            for (var r = i.getScale(), a = document.createElement("div"), l = 0; l < r.trace_x.length; l++) {
              var c = r.trace_x[l], d = r.trace_x[l + 1] || t.date.add(c, r.step, r.unit), h = r.trace_x[l].valueOf(),
                u = Math.min(e[h] / n, 1) || 0;
              if (u < 0) return null;
      ...
      n = n.replace("editing=true&", ""), this.getUpdates(n, function (i) {
        ...
        if (r.length) {
          ...
          for (var a = 0; a < r.length; a++) {
            var s = r[a].getAttribute("status"), o = r[a].getAttribute("id"), l = r[a].getAttribute("parent");
            switch (s) {
              case"inserted":
  ...
  t.exports = {
    removeLineHighlight: function (t) {
      ...
      s || ((s = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker", s.innerHTML = "<div class='gantt_grid_dnd_marker_line'></div>", s.style.pointerEvents = "none", document.body.appendChild(s), e.markerLine = s), t.child ? function (t, e, i) {
        ...
        var n = function (t, e) {
          var i = e.$config.rowStore, n = {x: 0, y: 0}, a = e.$grid_data.querySelector(".gantt_tree_indent"), s = 15,
            o = 0;
  ...
  t.exports = function (t) {
    var e = {
      ...
      path: [], clear: function () {
        ...
        var r = i.$getConfig(), a = this.get_line_type(e, r), s = a.from_start, o = a.to_start, l = t.getTask(e.source),
          c = t.getTask(e.target), d = n(l, i), h = n(c, i);
        ...
        switch (d) {
          ...
          case c.TAB:
            if (t.isVisible()) {
              ...
              var u = t.getState();
              u.id && a.focus({type: "taskCell", id: u.id, column: u.columnName}), r.preventDefault(), h = !0
            }
            break;
          default:
      ...
      init: u, createEditors: function (n) {
        ...
        var a = [], s = null, o = {
          ...
          locateCell: function (t) {
            ...
            var e = d.locateAttribute(t, n.$config.item_attribute), i = d.locateAttribute(t, "data-column-name");
            if (i) {
          ...
          save: function () {
            if (this.isVisible() && s.exists(this._itemId) && this.isChanged()) {
              ...
              if (s.exists(e)) {
                var r = s.getItem(e), a = this.getEditorConfig(i),
                  o = {id: e, columnName: i, newValue: this.getValue(), oldValue: this._getItemValue()};
  ...
  var n = i(2), r = i(1), a = i(0), s = i(12), o = function (t) {
    ...
    return n(e, t), e.prototype.init = function (t) {
      ...
      var e = this._isHorizontal() ? "width" : "height", i = this._isHorizontal() ? this.$scroll_hor : this.$scroll_ver,
        n = this._getScrollOffset(), a = i.firstChild;
  ...
  t.exports = function (t) {
    ...
    return {
      getDataRender: function (e) {
        ...
        var n = i.name, r = i.defaultContainer, a = i.defaultContainerSibling, s = e.createGroup(r, a, function (t, e) {
      ...
      initTemplates: function () {
        ...
        i("date_scale", !0, void 0, t.config, t.templates), i("date_grid", !0, "grid_date_format", t.config, t.templates), i("task_date", !0, void 0, t.config, t.templates), t.mixin(t.templates, {
          ...
          drag_link: function (e, i, n, r) {
            e = t.getTask(e);
            var a = t.locale.labels, s = "<b>" + e.text + "</b> " + (i ? a.link_start : a.link_end) + "<br/>";
  ...
  t.exports = function (t) {
    return {
      cache: !0, method: "get", parse: function (t) {
        ...
        if (c.setRequestHeader("X-Requested-With", "XMLHttpRequest"), c.send(r), !a) return {xmlDoc: c, filePath: i}
