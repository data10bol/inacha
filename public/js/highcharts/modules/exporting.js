  ...
  var D = function () {
    return {
      initUpdate: function (f) {
        ...
        h.navigation.updates.push({update: f, context: h})
      }
    }
  }();
  (function (f, h) {
    var p = f.defaultOptions, q = f.doc, B = f.Chart, r = f.addEvent, D = f.removeEvent, E = f.fireEvent,
      w = f.createElement, F = f.discardElement, y = f.css, n = f.merge, u = f.pick, G = f.objectEach, z = f.extend,
      K = f.isTouchDevice, A = f.win, I = A.navigator.userAgent, H = f.SVGRenderer, J = f.Renderer.prototype.symbols,
    ...
    f.post = function (b, a, d) {
      var c = w("form", n({method: "post", action: b, enctype: "multipart/form-data"},
        d), {display: "none"}, q.body);
      G(a, function (a, b) {
        w("input", {type: "hidden", name: b, value: a}, null, c)
      });
      c.submit();
      F(c)
    };
    z(B.prototype, {
      sanitizeSVG: function (b, a) {
        ...
        z(k.chart, {animation: !1, renderTo: d, forExport: !0, renderer: "SVGRenderer", width: c, height: m});
        ...
        return this.getSVG(n({chart: {borderRadius: 0}}, d.chartOptions,
          a, {
            exporting: {
        ...
        var a = this, d = [], c = q.body, f = c.childNodes, m = a.options.exporting.printMaxWidth, k, e;
        if (!a.isPrinting) {
          a.isPrinting = !0;
          a.pointer.reset(null, 0);
          E(a, "beforePrint");
          if (e = m && a.chartWidth > m) k = [a.options.chart.width,
            void 0, !1], a.setSize(m, void 0, !1);
        ...
        var e = this, x = e.options.navigation, l = e.chartWidth, t = e.chartHeight, h = "cache-" + b, g = e[h],
          C = Math.max(v, m), n;
        g || (e.exportContextMenu =
          e[h] = g = w("div", {className: b}, {
            position: "absolute",
            zIndex: 1E3,
            padding: C + "px",
            pointerEvents: "auto"
          }, e.fixedDiv || e.container), n = w("div", {className: "highcharts-menu"}, null, g), e.styledMode || y(n, z({
          ...
          if (f.isObject(a, !0)) {
            ...
            }, y(b, z({cursor: "pointer"}, x.menuItemStyle))));
      ...
      addButton: function (b) {
        var a = this, d = a.renderer, c = n(a.options.navigation.buttonOptions, b), f = c.onclick, m = c.menuItems, k,
          e, h = c.symbolSize || 12;
        a.btnCount || (a.btnCount = 0);
        a.exportDivElements || (a.exportDivElements = [], a.exportSVGElements = []);
        if (!1 !== c.enabled) {
          var l = c.theme, t = l.states, q = t && t.hover, t = t && t.select, g;
          ...
          e = d.button(c.text, 0, 0, g, l, q, t).addClass(b.className).attr({title: u(a.options.lang[c._titleKey || c.titleKey], "")});
          ...
          e.add(a.exportingGroup).align(z(c, {width: e.width, x: u(c.x, a.buttonOffset)}), !0, "spacingBox");
        ...
        var d = a.exportDivElements, c = a.exportEvents, h;
        b &&
    ...
    B.prototype.inlineStyles = function () {
      ...
      function a(d) {
        ...
        if (1 === d.nodeType && -1 === k.indexOf(d.nodeName)) {
          ...
          if (M || L) for (var w in g) m(g[w], w); else G(g, m);
      ...
      var d = this.renderer, c = d.inlineToAttributes, f = d.inlineBlacklist, h = d.inlineWhitelist,
        k = d.unstyledElements, e = {}, x, l, d = q.createElement("iframe");
      y(d, {width: "1px", height: "1px", visibility: "hidden"});
    ...
    B.prototype.renderExporting = function () {
      ...
      b.isDirtyExporting &&
      b.destroyExport();
      c && !1 !== a.enabled && (b.exportEvents = [], b.exportingGroup = b.exportingGroup || b.renderer.g("exporting-group").attr({zIndex: 3}).add(), G(d, function (a) {
        b.addButton(a)
