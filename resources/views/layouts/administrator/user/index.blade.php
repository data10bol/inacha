              ...
              <table class="table table-hover dataTable"
                ...
                @forelse($user as $item)
                  <tr>
                    ...
                    <td class="align-top text-left">{{ $item->employee }}</td>
                    <td class="align-top text-left">{{ $item->name }}</td>
                    <td class="align-top text-left">{{ $item->position->department->name }}</td>
                    <td class="align-top text-left">{{ $item->position->name }}</td>
