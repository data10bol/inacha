...
class JsTransformerPresenter
{
    ...
    public function encode_plot_options()
    {
        ...
        $this->plotOptions = !empty($data) ? 'plotOptions: '.json_encode($data,JSON_UNESCAPED_UNICODE).',' : null;
    ...
    public function encode_tooltip()
    {
      ...
      $this->tooltip = !empty($data) ? 'tooltip: '.json_encode($data, JSON_UNESCAPED_UNICODE).',' : null;
